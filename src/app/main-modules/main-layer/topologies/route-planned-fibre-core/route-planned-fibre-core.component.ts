import { Component, AfterViewInit, OnDestroy, ComponentFactoryResolver, ViewContainerRef } from '@angular/core';
...
export class RoutePlannedFibreCoreComponent implements AfterViewInit, OnDestroy  {
  ...
  async routeClicked() {
    ...
    const data = this.viewContainerRef.createComponent(
        this.cfr.resolveComponentFactory(RoutePopupComponent)
    );
    data.instance.routeName = "hello world";
    console.log(data)
  }
