...
@Component({
  selector: 'app-sla-conformance-nodewise',
  templateUrl: './sla-conformance-nodewise.component.html',
  styleUrls: ['./sla-conformance-nodewise.component.scss'],
  providers: [
...
export class SlaConformanceNodewiseComponent implements OnInit {
  public displayName;
  public jsonUrl;
  columnDefs: any;
