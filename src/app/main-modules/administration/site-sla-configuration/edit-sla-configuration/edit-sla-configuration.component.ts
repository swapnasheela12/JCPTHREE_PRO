...
@Component({
  selector: 'app-edit-sla-configuration',
  templateUrl: './edit-sla-configuration.component.html',
  styleUrls: ['./edit-sla-configuration.component.scss']
})
export class EditSlaConfigurationComponent {
