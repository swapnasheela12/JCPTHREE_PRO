...
@Component({
  selector: 'odsc-app-reason-templates',
  templateUrl: './odsc-reason-templates.component.html',
  styleUrls: ['./odsc-reason-templates.component.scss']
})
export class OdscReasonTemplatesComponent implements OnDestroy {
