  ...
  @Component({
    selector: 'app-odsc-history',
    templateUrl: './odsc-history.component.html',
    styleUrls: ['./odsc-history.component.scss']
  })
  export class OdscHistoryComponent implements OnInit {
    public gridApi;
    ...
    constructor(public dialogRef: MatDialogRef<OdscHistoryComponent>,
