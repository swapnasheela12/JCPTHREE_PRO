import { EditPredictionSchedulingComponent,EditPredictionSchedulingDialogModel } from './edit-prediction-scheduling/edit-prediction-scheduling.component';
import { NpCreatePopupComponent,NpCreatePopupDialogModel } from './../../../../modules/planning-deployment/nominal-capacity/np-create-popup/np-create-popup.component';
...
const PATHS = [
  ...
  { editPage: "/JCP/Administration/Platform-Administration/Coverage-Predictions/Create-Prediction-Scheduling" },
...
@Component({
  selector: 'app-prediction-scheduling',
  templateUrl: 'prediction-scheduling.component.html',
  styleUrls: ['prediction-scheduling.component.scss']
})
export class PredictionSchedulingComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.editRoute = PATHS[1].editPage;
    // this.createRoute = PATHS[2].createPage;
    // this.createRouteStrategy = PATHS[3].createPageStrategy;
  ...
  editPopup(): void {
    ...
    const dialogData = new EditPredictionSchedulingDialogModel();
    const dialogRef = this.dialog.open(EditPredictionSchedulingComponent, {
      data: dialogData,
      width: '500px',
      height: '235px',
      panelClass: 'edit-popup-dialog'
    });
  }
