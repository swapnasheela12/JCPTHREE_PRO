...
import { dropdown, R4GState, JC, City, dataSourceIndoor } from './../../../../../../core/components/common-elements/type-dropdown-modulelist';
import { MatSelect } from '@angular/material/select';
import { ViewChild, ViewContainerRef, ComponentFactoryResolver, Input } from '@angular/core';
import { ReplaySubject, Subject, of } from 'rxjs';
import { FormGroup, FormControl, FormBuilder } from '@angular/forms';
import { Component, OnInit, ViewEncapsulation, Type, ɵNG_COMP_DEF } from '@angular/core';
...
export class CreateTaskPageComponent  implements OnInit {
  ...
  private httpClientRowData() {
    this.http
      .get("assets/data/modules/network-planning/rf-planning/create-coverage-prediction.json")
      .subscribe(data => {
        this.rowData = data;
