...
@Component({
  selector: 'app-site-selection-layer',
  templateUrl: './site-selection-layer.component.html',
  styleUrls: ['./site-selection-layer.component.scss']
})
export class SiteSelectionLayerComponent implements AfterViewInit, OnDestroy {
  nominalArray = [];
