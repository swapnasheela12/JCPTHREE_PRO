...
@Component({
  selector: 'app-strategic-sites',
  templateUrl: './strategic-sites.component.html',
  styleUrls: ['./strategic-sites.component.scss']
})
export class StrategicSitesComponent implements OnInit {
