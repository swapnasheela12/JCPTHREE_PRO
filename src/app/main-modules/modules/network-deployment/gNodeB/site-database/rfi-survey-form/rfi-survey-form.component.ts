...
@Component({
  selector: 'app-rfi-survey-form',
  templateUrl: './rfi-survey-form.component.html',
  styleUrls: ['./rfi-survey-form.component.scss']
})
export class RfiSurveyFormComponent {
  woHeader: Array<any> = [
    {
      "label": "Circle Name",
      "value": "Mumbai"
  ...
  constructor(public dialogRef: MatDialogRef<RfiSurveyFormComponent>,
