...
@Component({
  selector: 'odsc-app-task-details',
  templateUrl: './odsc-task-details.component.html',
  styleUrls: ['./odsc-task-details.component.scss']
})
export class OdscTaskDetailsComponent implements OnInit {
