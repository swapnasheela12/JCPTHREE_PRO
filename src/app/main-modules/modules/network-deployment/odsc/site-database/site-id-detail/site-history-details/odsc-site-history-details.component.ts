...
@Component({
  selector: 'app-odsc-site-history-details',
  templateUrl: './odsc-site-history-details.component.html',
  styleUrls: ['./odsc-site-history-details.component.scss']
})
export class OdscSiteHistoryDetailsComponent implements OnDestroy {
