...
@Component({
  selector: 'app-odsc-site-database',
  templateUrl: './odsc-site-database.component.html',
  styleUrls: ['./odsc-site-database.component.scss']
})
export class OdscSiteDatabaseComponent {
  public taskDetails = [
    {
  ...
  cellClickedDetails(evt) {
    ...
    if (evt.value) {
      this.router.navigate(["JCP/Modules/Network-Deployment/Plan-To-Build/odsc/Site-Database/Site-Id-Details"]);
    }
  }
