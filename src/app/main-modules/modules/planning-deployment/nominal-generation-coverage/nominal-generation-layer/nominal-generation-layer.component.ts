...
import { FibreTableViewPopupModel, RouteTableViewComponent } from 'src/app/main-modules/main-layer/layer-list/topologies/fibre/route/route-table-view/route-table-view.component';
import { FivegSpiderViewComponent } from 'src/app/main-modules/main-layer/fiveg-spider-view/fiveg-spider-view.component';
import { LogicalConnectivityComponent } from 'src/app/main-modules/main-layer/layer-list/topologies/logical-connectivity/logical-connectivity.component';
...
@Component({
  selector: 'app-nominal-generation-layer',
  templateUrl: './nominal-generation-layer.component.html',
  styleUrls: ['./nominal-generation-layer.component.scss']
})
export class NominalGenerationLayerComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.dataShare.pinLayerCheck({name: "nominal-generation-layer"});
  ...
  createLayer = function (container, zoomLevel, routePlannedData, layerContainer, routeQueue) {
    ...
    console.log(this.structureContainer)
    this.stageRouteContainer.addChild(this.structureContainer);
    this.stageRouteContainer.update();
  }
  ...
  async colocatedStructureClicked(event, mainLayerReference, colocatedData, colocatedSpiderArray) {
    console.log(mainLayerReference)
