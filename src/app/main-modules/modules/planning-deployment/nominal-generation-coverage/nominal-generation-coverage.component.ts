...
const PATHS = [
  { createNominalGeneration: "JCP/Modules/Planning-Deployment/Nominal-Generation/Create" }
]

@Component({
  selector: 'app-nominal-generation-coverage',
  templateUrl: './nominal-generation-coverage.component.html',
  styleUrls: ['./nominal-generation-coverage.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class NominalGenerationCoverageComponent implements OnInit, OnDestroy {
  searchGrid = '';
