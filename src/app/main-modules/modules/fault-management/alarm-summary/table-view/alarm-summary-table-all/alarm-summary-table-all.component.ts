...
@Component({
  selector: 'app-alarm-summary-table-all',
  templateUrl: './alarm-summary-table-all.component.html',
  styleUrls: ['./alarm-summary-table-all.component.scss']
})
export class AlarmSummaryTableAllComponent implements OnInit {
  ...
  constructor(public datashare: DataSharingService,
    ...
    private router: Router, public matDialog: MatDialog, private _formBuilder: FormBuilder,) { 
