...
@Component({
  selector: 'app-recipe-view-tasks',
  templateUrl: './recipe-view-tasks.component.html',
  styleUrls: ['./recipe-view-tasks.component.scss']
})
export class RecipeViewTasksComponent {
  /////
  public gridApi;
  ...
  public opens = 'right';
  public drops = 'down';
  constructor(public dialogRef: MatDialogRef<RecipeViewTasksComponent>,
